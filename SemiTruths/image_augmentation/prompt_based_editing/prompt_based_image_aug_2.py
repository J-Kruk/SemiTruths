...
def generate_edits(args: argparse.Namespace, logger, dataloader, image_editor, caption_generator, caption_editor, gencap_dict, editcap_dict):
...
def create_prompt_based_edits(args: argparse.Namespace):
    ...
    image_editor, caption_generator, caption_editor =  prompt_based_edit_modules(args, logger, device)

    model = image_editor.model
    dataloader, model = accelerator.prepare(dataloader, model)
    gencap_dict,editcap_dict, args = generate_edits(args, logger, dataloader, image_editor, caption_generator, caption_editor, gencap_dict, editcap_dict)
