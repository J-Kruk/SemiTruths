...
def main():
    ...
    CAPTION_DATA_DIR = f"/raid/mphute6/HalfTruths/SemanticDefinition/outputs/consolidated/{DS}.json"
    IMG_DATA_DIR = f"/raid/mphute6/HalfTruths/Half_Truths_Dataset/images/{DS}/"
    FILTER_DATA_DIR = f"/raid/mphute6/HalfTruths/SemanticDefinition/outputs/quality_check/pregen/"
        ...
        for edit in caption_data_ds[fname]:
            ...
            try:
                if prune_length(caption_original, caption_edit):
                    ...
                    img1_cap1_similarity = calculate_image_caption_clip_similarity(img_original, caption_original)
                    img_sim.append(img1_cap1_similarity)

                    cap1_cap2_similarity = calculate_caption_clip_similarity(caption_original, caption_edit)
